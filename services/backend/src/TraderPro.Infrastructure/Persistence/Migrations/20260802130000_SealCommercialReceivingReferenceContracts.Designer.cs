...
namespace TraderPro.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802130000_SealCommercialReceivingReferenceContracts")]
    partial class SealCommercialReceivingReferenceContracts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("outbox_messages", "platform", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_outbox_messages_event_stream", "event_stream IN (1, 2, 3)");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialMasterChange", b =>
                {
                    b.Property<long>("Sequence")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("MasterVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("master_version");
                    ...
                    b.HasKey("Sequence")
                        .HasName("pk_commercial_master_changes");

                    b.HasIndex("WorkspaceId", "CompanyId", "Sequence")
                        .HasDatabaseName("ix_commercial_master_changes_company_sequence");

                    b.HasIndex("WorkspaceId", "CompanyId", "MasterType", "MasterId", "MasterVersion")
                        .IsUnique()
                        .HasDatabaseName("ux_commercial_master_changes_version");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingEntry", b =>
                {
                    ...
                    b.Property<short>("BagConstructionClassSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("bag_construction_class_snapshot");

                    b.Property<int>("BagCount")
                        .HasColumnType("integer")
                        .HasColumnName("bag_count");

                    b.Property<bool>("BagReturnableSnapshot")
                        .HasColumnType("boolean")
                        .HasColumnName("bag_returnable_snapshot");

                    b.Property<decimal>("BagTareWeightKgSnapshot")
                        .HasPrecision(20, 6)
                        .HasColumnType("numeric(20,6)")
                        .HasColumnName("bag_tare_weight_kg_snapshot");

                    b.Property<string>("BagTypeCodeSnapshot")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("bag_type_code_snapshot");

                    b.Property<Guid>("BagTypeId")
                        .HasColumnType("uuid")
                        .HasColumnName("bag_type_id");

                    b.Property<string>("BagTypeNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("bag_type_name_snapshot");

                    b.Property<long>("BagTypeVersionSnapshot")
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("DecimalPlacesSnapshot")
                        .HasColumnType("integer")
                        .HasColumnName("decimal_places_snapshot");

                    b.Property<string>("DisplayWeightKg")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("display_weight_kg");
                    ...
                    b.Property<string>("ProcessingFamilyCodeSnapshot")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("processing_family_code_snapshot");

                    b.Property<short>("ProcessingMethodSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("processing_method_snapshot");
                    ...
                    b.Property<Guid?>("ProductStandardBagWeightId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_standard_bag_weight_id");

                    b.Property<long?>("ProductStandardBagWeightVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("product_standard_bag_weight_version_snapshot");

                    b.Property<short>("ProductTypeSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("product_type_snapshot");

                    b.Property<long>("ProductVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("product_version_snapshot");
                    ...
                    b.Property<string>("StandardBagWeightLabelSnapshot")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("standard_bag_weight_label_snapshot");

                    b.Property<decimal?>("StandardContentWeightKgSnapshot")
                        .HasPrecision(20, 6)
                        .HasColumnType("numeric(20,6)")
                        .HasColumnName("standard_content_weight_kg_snapshot");

                    b.Property<Guid?>("SupplierProductScopeId")
                        .HasColumnType("uuid")
                        .HasColumnName("supplier_product_scope_id");

                    b.Property<long?>("SupplierProductScopeVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("supplier_product_scope_version_snapshot");

                    b.Property<short>("SupplierScopeModeSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("supplier_scope_mode_snapshot");

                    b.Property<string>("SupplierScopeValidationResultSnapshot")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("supplier_scope_validation_result_snapshot");
                    ...
                    b.HasIndex("WorkspaceId", "CompanyId", "ReceivingSessionId", "LocalSequence")
                        .IsUnique()
                        .HasDatabaseName("ux_commercial_receiving_entries_session_sequence");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingOwnership", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastReacquiredAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_reacquired_at_utc");

                    b.Property<DateTimeOffset?>("LastTransferredAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_transferred_at_utc");

                    b.Property<Guid?>("LastTransferredByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_transferred_by_user_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_commercial_receiving_ownerships");

                    b.HasIndex("WorkspaceId", "EditorDeviceId");

                    b.HasIndex("WorkspaceId", "CompanyId", "ReceivingSessionId")
                        .IsUnique()
                        .HasDatabaseName("ux_commercial_receiving_ownerships_session");

                    b.HasIndex("WorkspaceId", "CompanyId", "EditorDeviceId", "ReceivingSessionId")
                        .HasDatabaseName("ix_commercial_receiving_ownerships_editor");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingReferenceCounter", b =>
                {
                    b.Property<Guid>("WorkspaceId")
                        .HasColumnType("uuid")
                        .HasColumnName("workspace_id");
                    ...
                    b.HasKey("WorkspaceId", "CompanyId", "PolicyId", "PeriodKey")
                        .HasName("pk_commercial_receiving_reference_counters");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingReferencePolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_commercial_receiving_reference_policies");

                    b.HasAlternateKey("WorkspaceId", "CompanyId", "Id")
                        .HasName("ak_commercial_receiving_reference_policies_scope_id");

                    b.HasIndex("WorkspaceId", "CompanyId", "DocumentType")
                        .IsUnique()
                        .HasDatabaseName("ux_commercial_receiving_reference_policies_company_document");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingSession", b =>
                {
                    ...
                    b.Property<Guid>("CompanyProcurementSettingsId")
                        .HasColumnType("uuid")
                        .HasColumnName("company_procurement_settings_id");

                    b.Property<DateTimeOffset>("CreatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at_utc");

                    b.Property<string>("DestinationLocationCodeSnapshot")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("destination_location_code_snapshot");

                    b.Property<Guid>("DestinationLocationId")
                        .HasColumnType("uuid")
                        .HasColumnName("destination_location_id");

                    b.Property<string>("DestinationLocationNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("destination_location_name_snapshot");

                    b.Property<long>("DestinationLocationVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("destination_location_version_snapshot");
                    ...
                    b.Property<long>("ProcurementSettingsVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("procurement_settings_version_snapshot");

                    b.Property<Guid?>("ReceivingVehicleId")
                        .HasColumnType("uuid")
                        .HasColumnName("receiving_vehicle_id");

                    b.Property<long?>("ReceivingVehicleVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("receiving_vehicle_version_snapshot");
                    ...
                    b.Property<DateTimeOffset>("StartedAtDeviceUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("started_at_device_utc");

                    b.Property<DateTimeOffset>("StartedAtServerUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("started_at_server_utc");
                    ...
                    b.Property<short>("SupplierProductScopeModeSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("supplier_product_scope_mode_snapshot");

                    b.Property<long>("SupplierVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("supplier_version_snapshot");

                    b.Property<DateTimeOffset>("UpdatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("updated_at_utc");

                    b.Property<string>("VehicleCodeSnapshot")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("vehicle_code_snapshot");

                    b.Property<string>("VehicleDisplayNameSnapshot")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("vehicle_display_name_snapshot");

                    b.Property<string>("VehicleRegistrationSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("vehicle_registration_snapshot");

                    b.Property<short>("VehicleSelectionModeSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("vehicle_selection_mode_snapshot");
                    ...
                    b.Property<int>("WeightDecimalPlacesSnapshot")
                        .HasColumnType("integer")
                        .HasColumnName("weight_decimal_places_snapshot");

                    b.Property<long>("WeightPolicyVersionSnapshot")
                        .HasColumnType("bigint")
                        .HasColumnName("weight_policy_version_snapshot");

                    b.Property<short>("WeightProcessingMethodSnapshot")
                        .HasColumnType("smallint")
                        .HasColumnName("weight_processing_method_snapshot");

                    b.Property<Guid>("WeightProcessingPolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("weight_processing_policy_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_commercial_receiving_sessions");
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingOwnership", b =>
                {
                    b.HasOne("TraderPro.Domain.Platform.Device", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_commercial_receiving_ownerships_editor_device");

                    b.HasOne("TraderPro.Domain.Procurement.Receiving.CommercialReceivingSession", null)
                        .WithOne()
                        .HasForeignKey("TraderPro.Domain.Procurement.Receiving.CommercialReceivingOwnership", "WorkspaceId", "CompanyId", "ReceivingSessionId")
                        .HasPrincipalKey("TraderPro.Domain.Procurement.Receiving.CommercialReceivingSession", "WorkspaceId", "CompanyId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_commercial_receiving_ownerships_session");
                });
            ...
            modelBuilder.Entity("TraderPro.Domain.Procurement.Receiving.CommercialReceivingReferenceCounter", b =>
                {
                    b.HasOne("TraderPro.Domain.Procurement.Receiving.CommercialReceivingReferencePolicy", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_commercial_receiving_reference_counters_policy");
                });
