...
{
    private const string LockCommercialReceivingSnapshotsSql =
        """
        ...
        BEGIN
            ...
            IF reservation_row.session_id <> NEW.id OR
               ...
               reference_policy_row.version <> reservation_row.policy_version OR
               ...
               (CASE weight_policy_row.processing_method
                ...
                RAISE EXCEPTION 'Commercial Receiving Session snapshot does not match locked master facts.' USING ERRCODE = '55000';
            END IF;
        ...
        BEGIN
            ...
            IF session_row.id IS NULL OR session_row.status <> 1 OR
